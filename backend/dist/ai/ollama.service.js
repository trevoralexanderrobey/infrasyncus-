...
let OllamaService = OllamaService_1 = class OllamaService {
        ...
        this.availableModels = [
            {
                ...
                type: "text",
                ramUsage: 1.9,
                description: "Qwen 2.5 3B - Efficient text model with tool support (WEB SEARCH)",
                available: false,
            },
            {
                name: "codellama:7b",
    ...
    async checkAvailableModels() {
        try {
            ...
            if (response.ok) {
                ...
                this.logger.log(`Available models: ${this.availableModels
    ...
    getRecommendedModels() {
        ...
        return {
            ...
            multimodal: multimodalModels.length > 0
